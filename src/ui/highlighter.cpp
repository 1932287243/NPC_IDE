...
Highlighter::Highlighter(QTextDocument *parent, QString fontFamily, int fontSize): QSyntaxHighlighter(parent)
{
...
void Highlighter::setFont(QFont font)
{
...
void Highlighter::addKeywordsFromat()
{
...
void Highlighter::addFunctionFormat()
{
    HighlightRule rule;
